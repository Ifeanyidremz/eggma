...
NOWPAYMENTS_SANDBOX = os.getenv('NOWPAYMENTS_SANDBOX', 'False') == 'True'


REFERRAL_BONUS_AMOUNT = 10.00  # Bonus for referrer
REFERRAL_SIGNUP_BONUS = 5.00   # Bonus for new user
